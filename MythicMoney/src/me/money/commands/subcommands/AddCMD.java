...
public class AddCMD extends SubCommand {
	...
	public void perform(Player player, String[] args) {
		...
		MoneyAPI.adicionarMoney(target.getUniqueId().toString(), quantidade);
		player.sendMessage(ChatColor.GREEN + "Foram adicionados " + quantidade + " de coins na conta de " + target.getName() + ".");
	}
