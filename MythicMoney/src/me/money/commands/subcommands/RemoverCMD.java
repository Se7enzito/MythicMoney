...
public class RemoverCMD extends SubCommand {
	...
	public void perform(Player player, String[] args) {
		...
		MoneyAPI.removerMoney(player.getUniqueId().toString(), quantidade);
		player.sendMessage(ChatColor.GREEN + "Foram removidos " + quantidade + " coins da conta de " + target.getName() + ".");
	}
